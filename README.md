...
El programa permite cargar una Pokédex desde un archivo CSV, explorarla desde un menú interactivo y jugar un juego de memoria para dos jugadores utilizando los Pokémon cargados.
